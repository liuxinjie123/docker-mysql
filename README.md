...
```sh
$ sudo docker build ubuntu-mysql .
Sending build context to Docker daemon 95.23 kB
Sending build context to Docker daemon
Step 0 : FROM ubuntu-1404
 ---> 312c93647dc3
Step 1 : MAINTAINER hary <94093146@qq.com>
...
不添加环境变量，使用默认方式启动容器，并映射 `3306`端口。
```sh
...
eef1632ccd4e        mysql:latest        "/run.sh"           8 seconds ago       Up 8 seconds        0.0.0.0:49154->3306/tcp   angry_einstein
...
# docker ps
CONTAINER ID        IMAGE               COMMAND             CREATED              STATUS              PORTS                     NAMES
a781d1c74024        mysql:latest        "/run.sh"           About a minute ago   Up About a minute   0.0.0.0:49168->3306/tcp   romantic_fermi
38c73b5555aa        mysql:latest        "/run.sh"           About a minute ago   Up About a minute   0.0.0.0:49166->3306/tcp   mysql
```
